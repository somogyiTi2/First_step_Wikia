// const file = require('./file'); azonos mappában így jelölöm ki a fájlt
// const file = require('/file.js'); relativ útvonal megadása gyökérkönyvtárból

const http = require('http'); // Beimportáljuk a beépített http modult
// const fs = require('fs'); // Beimportáljuk a fájlkezeléshez szükséges fs modult

// Létrehozunk egy szervert, amely minden bejövő kérésre lefut

// const server = http.createServer((req, res) => {

// // // // // //   ÁTHLEYEZVE routes.js-be
...
const routes = require('./1_1-58_routes'); // beimportálom a routes.js fájlt
console.log(routes.someText); // ezzel elértem a routes.js-ben exportált someText változót
const server = http.createServer(routes.handler); //ezzel belehivatkozok
// http.createServer(routes); // ezzel rendelerem ki a routes.js fájlt a szerverhez
